...
const TRAIN_CASES = [
  {
    id: "t1",
    input: [
      { raw_date: "03/04/2024", raw_phone: "(212) 555-1234", raw_amount: "$1,500", raw_name: "Dr. John Smith" },
      { raw_date: "12/11/2023", raw_phone: "1-800-555-6789", raw_amount: "€2.500,50", raw_name: "MARIA GARCIA-LOPEZ" },
      { raw_date: "6/7/24", raw_phone: "5551234567", raw_amount: "45.5 kg", raw_name: "mr. james o'brien jr." },
      { raw_date: "11-01-2025", raw_phone: "+1 (415) 555.0199", raw_amount: "£3,200.00", raw_name: "Sarah J. Connor" },
      { raw_date: "07/08/2024", raw_phone: "212.555.8877", raw_amount: "0.75 miles", raw_name: "Kim, Soo-yeon" },
      { raw_date: "1/15/2025", raw_phone: "(800)5553000", raw_amount: "¥150,000", raw_name: "ROBERT CHEN III" },
    ] satisfies RawRecord[],
    expected: {
      records: [
        { date_iso: "2024-03-04", phone_e164: "+12125551234", amount_normalized: "1500.00 USD", name_normalized: "Smith, John" },
        { date_iso: "2023-12-11", phone_e164: "+18005556789", amount_normalized: "2500.50 EUR", name_normalized: "Garcia-Lopez, Maria" },
        { date_iso: "2024-06-07", phone_e164: "+15551234567", amount_normalized: "45.50 kg", name_normalized: "O'Brien, James" },
        { date_iso: "2025-11-01", phone_e164: "+14155550199", amount_normalized: "3200.00 GBP", name_normalized: "Connor, Sarah J." },
        { date_iso: "2024-07-08", phone_e164: "+12125558877", amount_normalized: "0.75 miles", name_normalized: "Kim, Soo-Yeon" },
        { date_iso: "2025-01-15", phone_e164: "+18005553000", amount_normalized: "150000.00 JPY", name_normalized: "Chen, Robert" },
...
const TEST_CASES = [
  {
    id: "test1",
    input: [
      { raw_date: "02/03/2025", raw_phone: "1 (646) 555-2211", raw_amount: "CHF 4'500.00", raw_name: "Dr. Anna-Maria ROSSI" },
      { raw_date: "9/10/24", raw_phone: "555-0101", raw_amount: "2.5 liters", raw_name: "lee, min-jun" },
    ] satisfies RawRecord[],
    expected: {
      records: [
        { date_iso: "2025-02-03", phone_e164: "+16465552211", amount_normalized: "4500.00 CHF", name_normalized: "Rossi, Anna-Maria" },
        { date_iso: "2024-09-10", phone_e164: "+15550101", amount_normalized: "2.50 liters", name_normalized: "Lee, Min-Jun" },
      ] satisfies NormalizedRecord[],
    },
  },
];
...
const OUTPUT_DIR = join(PROJECT_DIR, "experiment-normalize-output");
const AGENT_DIR = join(PROJECT_DIR, "experiment-normalize-agent");
...
The exact target formats are NOT provided here. You must discover them by analyzing
the scoring feedback. Pay close attention to which fields score 0 vs 1 — that tells
you whether your format guess is correct or wrong.

## Strategy
- Start by guessing reasonable normalized formats for dates, phones, amounts, and names.
- After each evaluation, look at the score. A score of 0 on a field means the format
  is wrong. Iterate on the format until you get exact matches.
- Consider edge cases: different date separators, phone number lengths, currency symbols
  vs unit strings, name prefixes/suffixes/ordering.
